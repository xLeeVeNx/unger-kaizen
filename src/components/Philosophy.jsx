        ...
        >
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Каратэ — это не только техника, сила и выносливость. Это характер, школа жизни.
            </p>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl lg:text-3xl font-bold text-dark-800 mb-4">
                Что даёт каратэ вашему ребёнку?
              </h3>
            </div>
            
            <div className="prose prose-lg mx-auto text-center text-gray-700 max-w-4xl">
              <p className="text-lg leading-relaxed">
                <strong>Шинкиокушинкай</strong> — это стиль каратэ, который формирует не просто бойца, 
